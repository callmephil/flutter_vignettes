...
class OBJLoaderFace {
  ...
  OBJLoaderFace()
      : _positions = List<vec32.Vector3?>.filled(3, null, growable: false),
        _normals = List<vec32.Vector3?>.filled(3, null, growable: false),
        _uvs = List<vec32.Vector2?>.filled(3, null, growable: false);
...
class VertexMeshInstance {
  ...
  void _cacheVertices() {
    ...
    List<vec32.Vector4?> transformedPositions = List<vec32.Vector4?>.filled(
      _mesh!.vertexCount,
      null,
      growable: false,
    );
